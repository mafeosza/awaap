							...
							<div class="col-sm-6">
								...
								<div class="control-group">
									...
									<div class="controls"><!--salto de linea-->
										<input type="text" id="nombre" name="nombre" value="<?php echo $informacionTema['nombre'];?>" class="input-xlarge">
										<p class="help-block">Por favor escribe el nombre del tema</p>
									</div>
								</div>	
							</div>
						</div>
