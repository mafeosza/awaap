							...
							<div class="col-sm-6">
								...
								<div class="control-group">
									...
									<div class="controls"><!--salto de linea-->
										<input type="text" id="documento" name="documento" value="<?php echo $informacionProfesor['documento'];?>" class="input-xlarge">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
								...
								<div class="control-group">
									...
									<div class="controls"><!--salto de linea-->
										<input type="text" id="nombre" name="nombre" value="<?php echo $informacionProfesor['nombre'];?>" class="input-xlarge">
									</div>
								</div>
							</div>
						</div>
						<div class="row fila">
							<div class="col-sm-6">
								...
								<div class="control-group">
									...
									<div class="controls"><!--salto de linea-->
										<input type="email" id="correo" name="correo" value="<?php echo $informacionProfesor['correo'];?>" class="input-xlarge">
									</div>
								</div>
							</div>
							<div class="col-sm-6">
